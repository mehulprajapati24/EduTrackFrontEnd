...
const FacultyLocation = () => {
  ...
  useEffect(() => {
    const fetchFaculties = async () => {
      try {
        const response = await axios.get('https://edutrackbackend-77k7.onrender.com/admin/get-faculty-data');
  ...
  const fetchLocation = async () => {
    try {
      ...
      const response = await axios.post('https://edutrackbackend-77k7.onrender.com/admin/get-faculty-location', { facultyName: selectedFaculty.facultyClassField });
