...
const PrincipalSearchStudent = () => {
  ...
  const fetchStudents = async () => {
    try {
      const response = await axios.post('https://edutrackbackend-opga.onrender.com/admin/get-students-data',{
  ...
  const handleStudentClick = async (student) => {
    try {
      const response = await axios.post('https://edutrackbackend-opga.onrender.com/admin/post-get-student-location', { className: student.class, batch: student.batch, academicYear: selectedAcademicYear, semester });
