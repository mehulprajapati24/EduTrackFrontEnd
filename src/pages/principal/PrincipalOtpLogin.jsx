...
const PrincipalOtpLogin = () => {
  ...
  const resendOtp = async () => {
    const response = await axios.post("https://edutrackbackend-opga.onrender.com/principal/otp", { email });
    setError('');
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://edutrackbackend-opga.onrender.com/principal/forgot-password/otp', { email, otp });
