...
const PrincipalViewTimetable = () => {
  ...
  const fetchTimetableOptions = async () => {
    try {
      const response = await axios.post('https://edutrackbackend-itns.onrender.com/admin/get-timetables-sheetname',{
  ...
  const handleTimetableSelection = async (selectedSheetName) => {
    ...
    try {
      const response = await axios.post('https://edutrackbackend-itns.onrender.com/admin/get-timetable-basedOnSheetName', {
  ...
  const handleDaySelection = async (selectedDay) => {
    ...
    try {
      const response = await axios.post('https://edutrackbackend-itns.onrender.com/admin/get-daywise-timetable', {
  ...
  useEffect(() => {
    if (selectedTime && selectedDay && selectedTimetable) {
      const fetchTimetableBasedOnTime = async () => {
        ...
        try {
          const response = await axios.post('https://edutrackbackend-itns.onrender.com/admin/get-timetable-based-on-time', {
              sheetName: selectedTimetable,
              day: selectedDay,
              time: selectedTime,
              academicYear: selectedAcademicYear,
...
//     const response = await axios.get('https://edutrackbackend-itns.onrender.com/admin/gettimes', {
//       params: {
...
//     const response = await axios.get('https://edutrackbackend-itns.onrender.com/get-timetable', {
//       params: {
//         academicYear: academicYear,
//         semester: semester,
//       },
