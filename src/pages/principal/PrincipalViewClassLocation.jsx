...
const PrincipalViewClassLocation = () => {
  ...
  const fetchClassOptions = async () => {
    try {
      const response = await axios.post(
        'https://edutrackbackend-opga.onrender.com/admin/get-class-timetables-sheetname',
        {
  ...
  const handleClassSelection = async (selectedClass) => {
    ...
    try {
      const response = await axios.post(
        'https://edutrackbackend-opga.onrender.com/admin/get-location-based-on-class-selection',
        {
          academicYear: selectedAcademicYear,
          semester,
          selectedClass,
...
export default PrincipalViewClassLocation;
