...
const FacultyChatbot = () => {
  ...
  const fetchTimetableData = async () => {
    try {
      ...
      if (token) {
        const response = await axios.get("https://edu-track-backend-ten.vercel.app/faculty/getFacultyTimetable", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const getShiftsOfFaculty = async () => {
    try {
      ...
      if (token) {
        const response = await axios.get("https://edu-track-backend-ten.vercel.app/faculty/getShiftsOfFaculty", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
