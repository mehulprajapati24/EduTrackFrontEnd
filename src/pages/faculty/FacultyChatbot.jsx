...
const FacultyChatbot = () => {
  ...
  const fetchStudents = async () => {
    try {
      const response = await axios.get('https://edutrackbackend-42jx.onrender.com/admin/get-students-data');
  ...
  const fetchFaculties = async () => {
    try {
      const response = await axios.get('https://edutrackbackend-42jx.onrender.com/admin/get-faculty-data'); // Adjusted API endpoint
  ...
  const fetchTimetableData = async () => {
    try {
      ...
      if (token) {
        const response = await axios.get("https://edutrackbackend-42jx.onrender.com/faculty/getFacultyTimetable", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const getShiftsOfFaculty = async () => {
    try {
      ...
      if (token) {
        const response = await axios.get("https://edutrackbackend-42jx.onrender.com/faculty/getShiftsOfFaculty", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const fetchStudentLocation = async () => {
    try {
      const response = await axios.get('https://edutrackbackend-42jx.onrender.com/admin/get-students-location'); // Adjust API endpoint as needed
...
if(timetableData){
  ...
  const handleSendMessage = async () => {
    if (input.trim()) {
      ...
      const responseLocation = await axios.post('https://edutrackbackend-42jx.onrender.com/admin/get-student-location-based-on-prompt',{
        enrollment,
        name,
        time,
        day
      ...
      const prompt = `
      I have data about student information, also having student location information, faculty information, weekly timetable information, my all shift information and other details. Here’s a summary:
