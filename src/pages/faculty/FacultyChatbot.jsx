...
const FacultyChatbot = () => {
  ...
  const getSchedule = async () => {
    try {
      ...
      if (token) {
        const response = await axios.get('https://edutrackbackend-rjl9.onrender.com/faculty/getSchedule', {
          headers: {
  ...
  const fetchTimetableData = async () => {
    try {
      ...
      if (token) {
        const response = await axios.get("https://edutrackbackend-rjl9.onrender.com/faculty/getFacultyTimetable", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const getShiftsOfFaculty = async () => {
    try {
      ...
      if (token) {
        const response = await axios.get("https://edutrackbackend-rjl9.onrender.com/faculty/getShiftsOfFaculty", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
