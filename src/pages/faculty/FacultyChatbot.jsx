...
const FacultyChatbot = () => {
  ...
  const getSchedule = async () => {
    try {
      ...
      if (token) {
        const response = await axios.get('https://edu-track-back-end.vercel.app/faculty/getSchedule', {
          headers: {
  ...
  const fetchTimetableData = async () => {
    try {
      ...
      if (token) {
        const response = await axios.get("https://edu-track-back-end.vercel.app/faculty/getFacultyTimetable", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const getShiftsOfFaculty = async () => {
    try {
      ...
      if (token) {
        const response = await axios.get("https://edu-track-back-end.vercel.app/faculty/getShiftsOfFaculty", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
