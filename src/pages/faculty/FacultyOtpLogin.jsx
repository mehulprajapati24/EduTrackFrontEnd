...
const FacultyOtpLogin = () => {
  ...
  const resendOtp = async () => {
    const response = await axios.post("https://edutrackbackend-itns.onrender.com/faculty/otp", { email });
    setError('');
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://edutrackbackend-itns.onrender.com/faculty/forgot-password/otp', { email, otp });
