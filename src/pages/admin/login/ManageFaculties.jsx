...
const ManageFaculties = () => {
  ...
  useEffect(() => {
    ...
    const fetchFaculties = async () => {
      try {
        const response = await axios.post("https://edutrackbackend-itns.onrender.com/admin/manage-faculties",{
  ...
  const handleDelete = async (id) => {
    ...
    const response = await axios.post('https://edutrackbackend-itns.onrender.com/admin/delete-faculty', {
      id
    });
