...
const ManageFaculties = () => {
  ...
  useEffect(() => {
    ...
    const fetchFaculties = async () => {
      try {
        const response = await axios.post("https://edutrackbackend-aq9w.onrender.com/admin/manage-faculties",{
  ...
  const handleDelete = async (id) => {
    ...
    const response = await axios.post('https://edutrackbackend-aq9w.onrender.com/admin/delete-faculty', {
      id
    });
