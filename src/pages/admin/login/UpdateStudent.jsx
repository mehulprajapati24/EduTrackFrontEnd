...
const UpdateStudent = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:5000/admin/update-student-with-data", {
        id: studentId,
  ...
  useEffect(() => {
    ...
    const response = await axios.post("http://localhost:5000/admin/get-student-for-update", {
        id
    });
