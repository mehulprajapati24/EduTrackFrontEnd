...
const UpdateStudent = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://edutrackbackend-opga.onrender.com/admin/update-student-with-data", {
        id: studentId,
  ...
  useEffect(() => {
    ...
    const response = await axios.post("https://edutrackbackend-opga.onrender.com/admin/get-student-for-update", {
        id
    });
