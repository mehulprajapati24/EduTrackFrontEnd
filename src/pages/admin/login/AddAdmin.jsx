...
const AddAdmin = () => {
  ...
  const handleAddAdmin = async (e) => {
    ...
    try {
      const response = await axios.post("https://edutrackbackend-opga.onrender.com/admin/addAdmin", { email });
  ...
  return (
    <div className="min-h-screen p-8 bg-gradient-to-r from-blue-200 to-blue-400 rounded">
      <h1 className="text-3xl font-bold text-center mb-8">Add New Admin</h1>
