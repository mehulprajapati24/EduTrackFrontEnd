...
const UpdateTimetable = () => {
  ...
  useEffect(() => {
    const fetchTimetableById = async () => {
      try {
        const response = await axios.post("https://edutrackbackend-77k7.onrender.com/admin/get-timetable-for-update", { id });
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://edutrackbackend-77k7.onrender.com/admin/update-timetable-with-data", {
        id,
