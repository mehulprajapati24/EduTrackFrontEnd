...
const AdminSearchFaculty = () => {
  ...
  const fetchFaculties = async () => {
    try {
      const response = await axios.post('https://edutrackbackend-itns.onrender.com/admin/get-faculty-data', {
  ...
  const handleFacultyClick = async (faculty) => {
    try {
      ...
      const response = await axios.post('https://edutrackbackend-itns.onrender.com/admin/get-faculty-location', { facultyName: faculty.facultyClassField }); // Adjusted payload
