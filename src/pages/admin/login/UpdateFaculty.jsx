...
const UpdateFaculty = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://edutrackbackend-77k7.onrender.com/admin/update-faculty-with-data", {
        id: facultyId,
  ...
  useEffect(() => {
    ...
    const response = await axios.post("https://edutrackbackend-77k7.onrender.com/admin/get-faculty-for-update", {
        id
    });
