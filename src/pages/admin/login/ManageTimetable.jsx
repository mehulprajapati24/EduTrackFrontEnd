...
const ManageTimetable = () => {
  ...
  useEffect(() => {
    if (selectedAcademicYear && semester) {
      const fetchTimetables = async () => {
        try {
          const response = await axios.post("https://edutrackbackend-itns.onrender.com/admin/manage-timetables", {
  ...
  const handleDelete = async (id) => {
    ...
    const response = await axios.post('https://edutrackbackend-itns.onrender.com/admin/delete-timetable', {
      id,
    });
