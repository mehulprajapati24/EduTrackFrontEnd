...
const ManageTimetable = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://edu-track-backend-ten.vercel.app/admin/create-timetable", {
        academicYear,
        semester,
        selectedClass,
        weeklyTimetable,
  ...
  const getClasses = async () => {
    const response = await axios.get('https://edu-track-backend-ten.vercel.app/admin/getclasses', {
      params: {
        academicYear,
        semester,
      },
  ...
  const getBatches = async () => {
    const response = await axios.get('https://edu-track-backend-ten.vercel.app/admin/getbatches', {
      params: {
        academicYear,
        semester,
        selectedClass
