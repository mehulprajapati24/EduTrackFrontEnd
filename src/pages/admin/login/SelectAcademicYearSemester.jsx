...
const SelectAcademicYearSemester = () => {
  ...
  const handleSaveSelection = async () => {
    if (selectedAcademicYear && selectedSemester) {
        try {
            // Make POST request
            const response = await axios.post('https://edutrackbackend-opga.onrender.com/admin/selected-year', {
...
export default SelectAcademicYearSemester;
