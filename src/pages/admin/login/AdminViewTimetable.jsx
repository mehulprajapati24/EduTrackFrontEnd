...
const SelectClassOrFaculty = () => {
  ...
  useEffect(() => {
    const fetchTimetableOptions = async () => {
      try {
        const response = await axios.get('https://edutrackbackend-rjl9.onrender.com/admin/get-timetables-sheetname');
  ...
  const handleTimetableSelection = async (selectedSheetName) => {
    ...
    try {
      const response = await axios.get('https://edutrackbackend-rjl9.onrender.com/admin/get-timetable-basedOnSheetName', {
        params: {
  ...
  const handleDaySelection = async (selectedDay) => {
    ...
    try {
      const response = await axios.get('https://edutrackbackend-rjl9.onrender.com/admin/get-daywise-timetable', {
        params: {
  ...
  useEffect(() => {
    if (selectedTime && selectedDay && selectedTimetable) {
      const fetchTimetableBasedOnTime = async () => {
        ...
        try {
          const response = await axios.get('https://edutrackbackend-rjl9.onrender.com/admin/get-timetable-based-on-time', {
            params: {
              sheetName: selectedTimetable,
              day: selectedDay,
              time: selectedTime,
...
//     const response = await axios.get('https://edutrackbackend-rjl9.onrender.com/get-timetable', {
//       params: {
//         academicYear: academicYear,
//         semester: semester,
//       },
