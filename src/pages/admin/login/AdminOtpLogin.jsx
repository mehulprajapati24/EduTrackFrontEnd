...
const AdminOtpLogin = () => {
  ...
  const resendOtp = async () => {
    const response = await axios.post("https://edutrackbackend-aq9w.onrender.com/admin/otp", { email });
    setError('');
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://edutrackbackend-aq9w.onrender.com/admin/forgot-password/otp', { email, otp });
