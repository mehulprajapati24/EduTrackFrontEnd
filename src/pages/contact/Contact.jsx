...
const Contact = () => {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
        setAccessKey(import.meta.env.VITE_ACCESS_KEY);
    }, []);
        ...
        <section className="bg-white container mx-auto rounded-lg">
            <div className="container px-6 py-12 mx-auto">
                <div>
                    ...
                    <h1 className="mt-2 text-2xl font-semibold md:text-3xl text-gray-800">Chat to our friendly team</h1>
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                    <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                        <div>
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">webmaster.uvpce@ganpatuniversity.ac.in</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">Ganpat Vidyanagar, Mehsana-Gandhinagar Highway</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+91-2762-226000, 286080, 286924</p>
                        </div>
                    </div>
                    ...
                    <div className="p-4 py-6 rounded-lg bg-gray-50 md:p-8">
                        <form action="https://api.web3forms.com/submit" method="POST">
                            ...
                            <div className="mt-4">
                                ...
                                <input type="email" name="email" placeholder="mehul123@gmail.com" className="block w-full px-5 py-2.5 mt-2 border rounded-lg placeholder-gray-400 bg-white text-gray-700 border-gray-200 focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                            </div>

                            <div className="w-full mt-4">
                                <label className="block mb-2 text-sm text-gray-600">Message</label>
                                <textarea name="message" className="block w-full h-32 px-5 py-2.5 mt-2 border rounded-lg placeholder-gray-400 bg-white text-gray-700 border-gray-200 md:h-48 focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Message..."></textarea>
                            </div>

                            <button type="submit" className="w-full px-6 py-2.5 mt-4 text-sm font-medium tracking-wide text-white capitalize bg-blue-500 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                Send Message
                            </button>
                        </form>
                    </div>
